...
struct ConstantInput{T}
    x::T
end

Base.popfirst!(in::ConstantInput) = in.x
userInput = ConstantInput(1)
userOutput = Int[]

runProgram(program, userInput, userOutput, false)

example = [1002,4,3,4,33]
runProgram(example, userInput, userOutput, false)

function runProgram(memory, userInput, output, withReset, i = 0, j = 0)
...
exampleMini1 = [3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9]
exampleMini2 = [3,3,1105,-1,9,1101,0,0,12,4,12,99,1]
